...
<header>
	<ul class="sidenav sidenav-fixed blue-grey darken-4">
		...
		<li class="active">
			<a class="orange-text text-lighten-2" href="/game">
				<i class="material-icons orange-text text-lighten-2">games</i>Game
			</a>
		</li>
		<li>
	...
	<div class="card-content grey-text text-lighten-2">
		...
		<div class="row">
			...
			<div class="col s7 offset-s1">
				<div>
					<h6 class="blue-text center-align"><strong>Stars</strong></h6>
				</div>
